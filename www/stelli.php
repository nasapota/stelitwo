...
if ($fp) {
	...
	echo "<h2>Временная ошибка. Попробуйте немного позже</h2>";
    exit;
}
?>
...
<html>
   <head>
   <title></title>
   <meta name="description" content="Изготовление и монтаж  натяжных потолков в Киеве и области. Французские, немецкие натяжные потолки. Бесшовные натяжные потолки и стены. Преимущества натяжных потолков. Гарантия.  Фотогалерея. Калькулятор. Интересные цены. Заказать натяжной потолок.">
   <meta name="keywords" content="натяжные потолки пвх цена, тканевые натяжные потолки, бесшовные натяжные потолки, цена натяжной потолок, цены натяжного потолка, натяжные потолки скидки, натяжные потолки прайс, натяжные потолки sidus, натяжные потолки цены, прайс на натяжные потолки, натяжные потолки стоимость, натяжные потолки акция, стоимость натяжных потолков, натяжные потолки киев цена, натяжные потолки недорого, рассчитать стоимость натяжного потолка, натяжные потолки калькулятор, калькулятор натяжных потолков, sidus натяжные потолки, натяжные потолки clipso цена, щвейцарские натяжные потолки">
...
<table CELLPADDING="0" CELLSPACING="0" align="center" width="780" height="23">
 ...
 height="23" width="81"
 src="m1off.jpg" alt="Главная"></a><img src="m.jpg" width="30" height="23"></td>
 ...
 height="23" width="188"
 src="m2off.jpg" alt="Натяжные потолки"></a><img src="m.jpg" width="30" height="23"></td>
 ...
 height="23" width="163"
 src="m3off.jpg" alt="Системы CLIPSO"></a><img src="m.jpg" width="30" height="23"></td>
 ...
 height="23" width="126"
 src="m4off.jpg" alt="Фотогалерея"></a><img src="m.jpg" width="30" height="23"></td>
 ...
 height="23" width="55"
 src="m5off.jpg" alt="Цены"></a><img src="m.jpg" width="30" height="23"></td>
 ...
 height="23" width="96"
 src="m6off.jpg" alt="Контакты"></a></td>
	</tr>
</table>
</td>
</tr>
...
<tr>
<td colspan="2">
<font size="-1"><a href="http://steli.kiev.ua/">Steli.kiev.ua</a></font><font size="-3">></font><a href="index.htm"><font size="-1">Главная</font></a><font size="-3">>></font><font size="-1">Цены</font>
...
<br>
<font size="+1">
Статьи о потолках:<br>
<font size="-1">
<ul type="circle">
      <li><a href="articles/compare.htm">Сравнение с традиционными способами отделки</a></li>

		<li><a href="articles/conditions.htm">Технические условия для помещений с натяжными потолками</a></li>
		<li><a href="articles/installation.htm">Монтаж натяжных потолков</a></li>				
</ul>
</font>
<a href="faq.htm">Вопросы</a><br>
<a href="calc.htm">Калькулятор</a><br>
</font>
<br>
<br>
<br>
...
<div style="text-align: center"><font size="+2" color="#ff6600"><font size="+2"><b>Акции:</b></font></font><br>
  <a href="actia.htm">Акция к 8 марта</a><br>c <strong><font color="#FF0000">08.02.11</font></strong> по <strong><font color="#FF0000">08.04.11</font></strong><br><br>
<font color="#FF6600"><font size="+1"><b>Дополнительня услуга:</b></font></font><br>
Гипсокартонные конструкции любой сложности<br>
<br>
<br>
<font color="#FF6600"><font size="+2"><b>Скорость:</b></font></font><br>

Оперативный замер<br>
Монтаж 2-3 потолка в день<br>
<br>
<br>
<font color="#FF6600"><font size="+2"><b>Качество:</b></font></font><br>
Чистый монтаж<br>
Гарантия <font size="-0"><i>на потолки</i></font>- <font color="#ff0000">12</font> лет<br>
...
<tr><td colspan="2" align="center">
	Телефоны: <b>(044) 360-16-37</b>, <b>(050) 356-16-37</b>, <b>(096) 505-808-9;</b> <br>Электронная почта: <a href="mailto:info@steli.kiev.ua ">info@steli.kiev.ua </a> <br><a href="http://www.icq.com/whitepages/cmd.php?uin=433316249&amp;action=message" style="text-decoration:none"><script type="text/javascript">
	<!--
